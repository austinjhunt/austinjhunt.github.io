  ...
  externalProjects: [
    {
    ...
    }, 
     {
      ...
      description:
        'Paid (Stripe-integrated) web service allowing subscribers to generate AI-backed quizzes about anything they want (with GPT Completions API), from uploaded files, to Wikipedia Articles, to any random topic of their choice. Mission: help visitors master and understand what interests them, beyond simple memorization.',
      imageUrl: '/img/projects/novabrains.png',
